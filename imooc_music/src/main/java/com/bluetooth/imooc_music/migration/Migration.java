package com.bluetooth.imooc_music.migration;

import com.bluetooth.imooc_music.models.MusicModel;
    ...
    public void migrate(DynamicRealm realm, long oldVersion, long newVersion) {
        ...
        if(oldVersion ==0){
             ...
             schema.create("MusicSourceModel")
                     .addRealmListField("",schema.get("AlbumModel"))
                     .addRealmListField("",schema.get("MusicModel"));
